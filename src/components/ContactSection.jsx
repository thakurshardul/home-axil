    ...
    const posts=[
        {
            ...
            href:'#',
            description:'It is a fantastic theme with tons of design and layout options, and the customer service is simply outstanding. They respond immediately and solve any inconvenience, no matter how small.',
            date:'Mar 16, 2024',
            datetime:'2024-03-16',
            ...
            author:{
                ...
                role:'Co-Founder/CTO',
                href:"#",
                imageURL:'/images/image/profile1.jpg'
            }
        },
        {
            id:2,
            ...
            author:{
                ...
                role:'Co-Founder/CEO',
                href:"#",
                imageURL:'/images/image/profile2.jpg'
            }
        },
        {
            id:3,
            ...
            author:{
                ...
                role:'Co-Founder/CTO',
                href:"#",
                imageURL:'/images/image/profile3.jpg'
            }
        }
    ]
    return (
                            ...
                            <article key={post.id} className="flex max-w-xl  flex-col items-start justify-between">
                                <div className="flex items-center gap-x-4 text-xs">
                                    <time datetime={post.datetime}>
                                        <img src="/images/image/star.svg" width={80} height={5}/>
                                    </time>
                                ...
                                <div className="relative mt-8 flex items-center gap-x-4 ">
                                    <img src={post.author.imageURL} className="h-10 w-10 rounded-full bg-gray-50 "/>
